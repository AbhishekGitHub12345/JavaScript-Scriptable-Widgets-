...
//  w.drawImageInRect(BG_IMAGE, new Rect(0, 0, WIDGET_DIM, WIDGET_DIM));
// w.backgroundImage = context.getImage();
w.backgroundImage = await nobg.getSliceForWidget(Script.name())
